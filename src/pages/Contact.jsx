  ...
  return (
    <div className='flex flex-col items-center justify-center'>
        ...
        <div className='flex flex-col lg:flex-row lg:justify-around lg:items-center lg:w-2/4'>
            <div id='contactInfoContainer' className='bg-lm-secondary dark:bg-dm-overlay2 transition duration-500 ease-in-out rounded-lg m-3 p-4'>
                <div className='flex flex-row justify-start items-center p-2'>
                    <div className='w-10 m-2 rounded-md bg-lm-secondaryVariant dark:bg-dm-secondary transition duration-500 ease-in-out'>
                ...
                <div className='flex flex-row justify-start items-center p-2'>
                    <div className='w-10 m-2 rounded-md bg-lm-secondaryVariant dark:bg-sm-secondary transition duration-500 ease-in-out text-lm-background dark:text-dm-onSecondary'>
                    <LocationMarkerIcon/>
                    </div>
                    <div className='text-lm-onSecondary dark:text-dm-onBackground ml-4'>
            ...
            <div className='bg-lm-secondary dark:bg-dm-overlay2 transition duration-500 ease-in-out mt-10 rounded-lg p-4 m-3'>
                <form action="https://formsubmit.co/clau.neme@gmail.com" method="POST">
                    <div className='flex flex-col items-start p-4'>
                        ...
                        <input name="name" className='bg-lm-background border-2 border-lm-secondaryVariant dark:bg-dm-overlay3 transition duration-500 ease-in-out dark:border-dm-secondary text-lm-onBackground dark:text-dm-onBackground font-extrabold rounded-md p-2' type="text" />
                    ...
                    <div className='flex flex-col items-start p-4'>
                        ...
                        <input name='email' className='bg-lm-background border-2 border-lm-secondaryVariant dark:bg-dm-overlay3 dark:border-dm-secondary transition duration-500 ease-in-out text-lm-onBackground dark:text-dm-onBackground font-extrabold rounded-md p-2' type="email" required/>
                    </div>
                    <div className='flex flex-col items-start p-4'>
                        <label className='text-lm-onSecondary dark:text-dm-onBackground font-bold pb-1'>Your message</label>
                        <textarea className='bg-lm-background border-2 border-lm-secondaryVariant dark:bg-dm-overlay3 transition duration-500 ease-in-out dark:border-dm-secondary text-lm-onBackground dark:text-dm-onBackground font-extrabold rounded-md p-2' name="message" id="message" required/>
                    </div>
                    <div className='flex justify-center items-center m-2'>
                    <button type='submit' className='bg-lm-secondary dark:hover:bg-dm-secondary text-lm-onSecondary dark:bg-dm-overlay2 transition duration-500 ease-in-out dark:text-dm-secondary dark:hover:text-dm-onSecondary font-extrabold text-lg rounded-md p-1 px-2 mb-4 ring-2 ring-lm-secondaryVariant dark:ring-dm-secondary ring-offset-1 ring-offset-transparent hover:bg-lm-secondaryVariant'>
                        Send
                    </button>
                    </div>
                </form>
